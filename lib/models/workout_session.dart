...
// Hive Adapter (manually written — run build_runner in real project)
class WorkoutSessionAdapter extends TypeAdapter<WorkoutSession> {
  ...
  WorkoutSession read(BinaryReader reader) {
    return WorkoutSession(
      ...
      hrv: reader.read(),
      muscleGroupsWorked: List<String>.from(reader.read()),
      perceivedExertion: reader.read(),
      vo2Max: reader.read(),
      source: reader.read(),
    );
  }
  ...
  void write(BinaryWriter writer, WorkoutSession obj) {
    ...
    writer.write(obj.muscleGroupsWorked);
    writer.write(obj.perceivedExertion);
    writer.write(obj.vo2Max);
